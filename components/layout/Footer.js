        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <Link href="/" className="flex items-center space-x-2 mb-6">
              ...
              <span className="text-xl font-bold">Chalet Manager</span>
            </Link>
            ...
            <div className="mb-6">
              ...
              <form className="space-y-2">
                <input
                  ...
                  className="w-full px-4 py-2 bg-neutral-800 border border-neutral-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent text-white placeholder-neutral-400"
                />
                <button
                  type="submit"
